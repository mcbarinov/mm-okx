...
public_app = typer.Typer(no_args_is_help=True, help="Public API commands")
app.add_typer(public_app, name="public")
app.add_typer(public_app, name="p", hidden=True)


@public_app.command(name="instruments", help="Get all instruments")
...
@public_app.command(name="instrument", help="Get instrument")
...
@public_app.command(name="tickers", help="Get all tickers")
def tickers_command(
    inst_type: InstTypeOption = "SPOT",
    proxy: ProxyOption = None,
) -> None:
...
@public_app.command(name="ticker", help="Get ticker")
def ticker_command(
    inst_id: InstIdArgument,
    proxy: ProxyOption = None,
) -> None:
